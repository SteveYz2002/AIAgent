...
public class ToolCallAgent extends ReActAgent {
    ...
    // 可用的工具
    public final ToolCallback[] availableTools;

    // 保存工具调用信息的响应结果（要调用哪些工具）
    public ChatResponse toolCallChatResponse;

    // 工具调用管理者
    public final ToolCallingManager toolCallingManager;

    // 工具调用选项（禁用Spring AI 内置的工具调用机制）
